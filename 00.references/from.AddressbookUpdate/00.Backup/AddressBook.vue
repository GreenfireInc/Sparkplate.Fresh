<template>
  <div class="address-book-container">
    <div class="header">
      <h1>Address Book</h1>
      <div class="actions">
        <button class="btn" @click="openAddContactModal">Add contact</button>
    ...
    <AddContactModal v-if="showAddContactModal" :contact="selectedContactForEdit" @close="closeAddContactModal" @contact-saved="loadContacts" />
    <ContactDetailsModal v-if="showContactDetailsModal" :contact="selectedContactForDetails" @close="closeContactDetailsModal" />
    <ConfirmModal 
