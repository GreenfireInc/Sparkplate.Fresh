// Ethereum Classic NFT Minting via Lighthouse IPFS
...
export class ETCLighthouseNFTMinter {
  ...
  constructor(lighthouseConfig: LighthouseConfig, rpcEndpoint: string = 'https://etc.rivet.link', network: 'mainnet' | 'mordor' = 'mainnet') {
...
export default ETCLighthouseNFTMinter;
