// Tezos NFT Minting via Lighthouse IPFS
...
export class TezosLighthouseNFTMinter {
  ...
  constructor(lighthouseConfig: LighthouseConfig, rpcUrl: string = 'https://mainnet.api.tez.ie', network: 'mainnet' | 'ghostnet' | 'kathmandunet' = 'mainnet') {
...
export default TezosLighthouseNFTMinter;
