// ChangeNow Ramp API Integration
...
export class ChangeNowRampClass {
...
export const ChangeNowRamp = {
  // Quick access methods
  async getCurrencies(): Promise<any[]> {
    const instance = new ChangeNowRampClass();
  ...
  // Static properties
  info: ChangeNowRampClass.info,
  socialMedia: ChangeNowRampClass.socialMedia,
};

// Export the class as default
export default ChangeNowRamp;
