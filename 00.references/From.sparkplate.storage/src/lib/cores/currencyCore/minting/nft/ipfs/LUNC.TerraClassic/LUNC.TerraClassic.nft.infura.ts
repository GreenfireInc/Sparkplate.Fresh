// Terra Classic NFT Minting via Infura IPFS
...
export class TerraClassicInfuraNFTMinter {
  private ipfs: IPFSHTTPClient;
  private infuraGateway: string;
  private rpcEndpoint: string;
  private network: 'mainnet' | 'testnet';

  constructor(infuraConfig: InfuraConfig, rpcEndpoint: string = 'https://terra-classic-lcd.publicnode.com', network: 'mainnet' | 'testnet' = 'mainnet') {
...
export default TerraClassicInfuraNFTMinter;
