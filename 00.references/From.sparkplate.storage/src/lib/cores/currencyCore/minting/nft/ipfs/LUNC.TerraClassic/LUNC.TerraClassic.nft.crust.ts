// Terra Classic NFT Minting via Crust Network
...
export class TerraClassicCrustNFTMinter {
  ...
  constructor(crustConfig: CrustConfig, rpcEndpoint: string = 'https://terra-classic-lcd.publicnode.com', network: 'mainnet' | 'testnet' = 'mainnet') { this.crustConfig = crustConfig; this.rpcEndpoint = rpcEndpoint; this.network = network; }
...
export default TerraClassicCrustNFTMinter;
