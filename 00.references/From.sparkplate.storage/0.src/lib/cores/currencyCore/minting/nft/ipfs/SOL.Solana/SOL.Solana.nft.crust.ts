// Solana NFT Minting via Crust Network
...
export class SolanaCrustNFTMinter {
  ...
  constructor(crustConfig: CrustConfig, rpcEndpoint: string = 'https://api.mainnet-beta.solana.com', network: 'mainnet-beta' | 'devnet' | 'testnet' = 'mainnet-beta') {
    this.crustConfig = crustConfig; this.connection = new Connection(rpcEndpoint, 'confirmed'); this.network = network;
  }
...
export default SolanaCrustNFTMinter;
