// Stellar NFT Minting via Crust Network
...
export class StellarCrustNFTMinter {
  ...
  constructor(crustConfig: CrustConfig, horizonUrl: string = 'https://horizon.stellar.org', network: 'mainnet' | 'testnet' = 'mainnet') {
...
export default StellarCrustNFTMinter;
