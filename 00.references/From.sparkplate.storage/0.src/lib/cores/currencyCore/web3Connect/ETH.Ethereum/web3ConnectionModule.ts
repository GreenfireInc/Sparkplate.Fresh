/**
 * Ethereum Web3 Connection Module
 * 
 * Vuex/Pinia module for managing ETH web3 connections
...
export default {
  ...
  actions: {
    ...
    async metamaskSwitchToETH(_: any, { network }: { network: 'mainnet' | 'sepolia' | 'goerli' | 'holesky' }) {
      return await metamaskConnect.switchToETH(network);
    },
    ...
    async metamaskIsOnETH(_: any) {
      return await metamaskConnect.isOnETH();
    },
