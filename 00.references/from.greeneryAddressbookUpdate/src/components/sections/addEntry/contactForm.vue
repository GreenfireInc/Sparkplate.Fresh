...
import { type Contact, addContact, updateContact } from '../../../services/contactService';
import { type Wallet, addWallet, getWalletsForContact, updateWallet, deleteWallet } from '../../../services/walletService';
...
const form = ref<Omit<Contact, 'id'> & { id?: number }>({ type: 'regular', firstname: '', lastname: '', email: '', company: '', notes: '' });
...
watch(() => props.contact, (newContact) => {
  if (newContact) {
    ...
    form.value = { type: 'regular', firstname: '', lastname: '', email: '', company: '', notes: '' };
    wallets.value = [];
  }
}, { immediate: true });
