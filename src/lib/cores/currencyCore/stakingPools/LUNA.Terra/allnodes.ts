// Allnodes Staking Pool for Terra (LUNA)
...
const tx = await allnodes.stakeLUNA(stakeAmount, validatorAddress);
await tx.wait();
...
// Helper function to get LUNA price from Allnodes
