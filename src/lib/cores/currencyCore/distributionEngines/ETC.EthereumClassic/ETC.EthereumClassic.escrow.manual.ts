/**
 * Ethereum Classic (ETC) Manual Escrow System for Gaming
 * Server-managed escrow for peer-to-peer gaming on Ethereum Classic
 * "Code is Law" - Immutable blockchain logic
 */
...
export interface GameConfig {
  betAmount: string; // Amount in ETC
...
export class EthereumClassicGameEscrow {
...
export class EthereumClassicGameServer {
  private escrow: EthereumClassicGameEscrow;

  constructor(escrow: EthereumClassicGameEscrow) {
    this.escrow = escrow;
  }
...
export default EthereumClassicGameEscrow;
