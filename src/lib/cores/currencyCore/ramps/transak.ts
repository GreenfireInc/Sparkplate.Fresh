...
export class TransakRampClass {
  private config: TransakConfig;
  private baseUrl: string;

  constructor(config: TransakConfig = {}) {
    this.config = config;
    this.baseUrl = config.baseUrl || (config.sandbox ? 'https://api-staging.transak.com' : 'https://api.transak.com');
  }
  ...
  static readonly info = {
    ...
    apiDocs: 'https://docs.transak.com/',
    status: 'Active',
  ...
  static readonly socialMedia = {
    ...
    telegram: 'https://t.me/transak',
    discord: 'https://discord.gg/transak',
    reddit: 'https://www.reddit.com/r/transak/',
    youtube: 'https://www.youtube.com/transak',
    facebook: 'https://www.facebook.com/transak',
    linkedin: 'https://www.linkedin.com/company/transak',
  };

  /**
   * Make request to Transak API
   */
  private async makeRequest(endpoint: string, params: Record<string, any> = {}): Promise<any> {
    ...
    if (result.error) {
      throw new Error(`Transak API error: ${result.error}`);
    }
...
export const TransakRamp = {
  // Quick access methods
  async getCurrencies(): Promise<any[]> {
    const instance = new TransakRampClass();
  ...
  // Static properties
  info: TransakRampClass.info,
  socialMedia: TransakRampClass.socialMedia,
};

// Export the class as default
export default TransakRamp;
