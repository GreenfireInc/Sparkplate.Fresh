...
export class RampRampClass {
  private config: RampConfig;
  private baseUrl: string;

  constructor(config: RampConfig = {}) {
    this.config = config;
    this.baseUrl = config.baseUrl || (config.sandbox ? 'https://api-staging.ramp.network' : 'https://api.ramp.network');
  }
  ...
  static readonly info = {
    ...
    apiDocs: 'https://docs.ramp.network/',
    status: 'Active',
  ...
  static readonly socialMedia = {
    ...
    telegram: 'https://t.me/rampnetwork',
    discord: 'https://discord.gg/rampnetwork',
    reddit: 'https://www.reddit.com/r/rampnetwork/',
    youtube: 'https://www.youtube.com/rampnetwork',
  ...
  private async makeRequest(endpoint: string, params: Record<string, any> = {}): Promise<any> {
    ...
    if (result.error) {
      throw new Error(`Ramp API error: ${result.error}`);
    }
...
export const RampRamp = {
  // Quick access methods
  async getCurrencies(): Promise<any[]> {
    const instance = new RampRampClass();
  ...
  // Static properties
  info: RampRampClass.info,
  socialMedia: RampRampClass.socialMedia,
};

// Export the class as default
export default RampRamp;
