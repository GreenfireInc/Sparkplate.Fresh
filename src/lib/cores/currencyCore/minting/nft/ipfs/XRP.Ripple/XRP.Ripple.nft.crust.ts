// XRP NFT Minting via Crust Network
...
export class XRPCrustNFTMinter {
  ...
  constructor(crustConfig: CrustConfig, xrplServer: string = 'wss://xrplcluster.com', network: 'mainnet' | 'testnet' | 'devnet' = 'mainnet') {
...
export default XRPCrustNFTMinter;
