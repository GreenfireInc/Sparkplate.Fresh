// Tron NFT Minting via Lighthouse IPFS
...
export class TronLighthouseNFTMinter {
  ...
  constructor(lighthouseConfig: LighthouseConfig, fullNode: string = 'https://api.trongrid.io', network: 'mainnet' | 'shasta' | 'nile' = 'mainnet') {
...
export default TronLighthouseNFTMinter;
