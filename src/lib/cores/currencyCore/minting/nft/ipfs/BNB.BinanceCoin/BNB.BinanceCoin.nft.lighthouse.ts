// BNB Smart Chain NFT Minting via Lighthouse IPFS
// Decentralized storage with encryption for BSC BEP-721
...
export class BNBLighthouseNFTMinter {
...
export default BNBLighthouseNFTMinter;
