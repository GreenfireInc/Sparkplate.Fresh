// Ethereum Classic NFT Minting via Crust Network
...
export class ETCCrustNFTMinter {
  ...
  constructor(crustConfig: CrustConfig, rpcEndpoint: string = 'https://etc.rivet.link', network: 'mainnet' | 'mordor' = 'mainnet') {
...
export default ETCCrustNFTMinter;
