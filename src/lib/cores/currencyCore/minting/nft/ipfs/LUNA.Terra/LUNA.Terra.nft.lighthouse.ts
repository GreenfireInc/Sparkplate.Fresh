// Terra NFT Minting via Lighthouse IPFS
...
export class TerraLighthouseNFTMinter {
  ...
  constructor(lighthouseConfig: LighthouseConfig, rpcEndpoint: string = 'https://phoenix-lcd.terra.dev', network: 'mainnet' | 'testnet' = 'mainnet') { this.lighthouseConfig = lighthouseConfig; this.rpcEndpoint = rpcEndpoint; this.network = network; }
...
export default TerraLighthouseNFTMinter;
