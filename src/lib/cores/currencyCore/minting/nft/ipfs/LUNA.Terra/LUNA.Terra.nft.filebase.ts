// Terra NFT Minting via Filebase IPFS
...
export class TerraFilebaseNFTMinter {
  private s3: AWS.S3;
  ...
  constructor(filebaseConfig: FilebaseConfig, rpcEndpoint: string = 'https://phoenix-lcd.terra.dev', network: 'mainnet' | 'testnet' = 'mainnet') {
...
export default TerraFilebaseNFTMinter;
