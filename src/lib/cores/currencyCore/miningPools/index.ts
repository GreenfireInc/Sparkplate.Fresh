 ...
 * import { BCH, BTC, DOGE, ETC, LTC } from '@/lib/cores/currencyCore/miningPools';
 * 
 * // Bitcoin Cash
 ...
 * import { ViaBTCPool, getBCHPrice } from '@/lib/cores/currencyCore/miningPools/BCH.BitcoinCash';
 * import { FoundryUSAPool, getBTCPrice } from '@/lib/cores/currencyCore/miningPools/BTC.Bitcoin';
 * ```
 */
