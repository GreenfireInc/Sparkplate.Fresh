...
export const togo: EcowasCountry = {
  ...
  domesticPostService: ECOWAS_DOMESTIC_POST_SERVICES['TG'],
  nationalBankingInstitutions: ECOWAS_NATIONAL_BANKING_INSTITUTIONS['TG'],
  corporationFormationOffice: ECOWAS_CORPORATION_FORMATION_OFFICES['TG'],
  ...
  mainInternationalSeaport: ECOWAS_MAIN_INTERNATIONAL_SEAPORTS['TG'],
}
