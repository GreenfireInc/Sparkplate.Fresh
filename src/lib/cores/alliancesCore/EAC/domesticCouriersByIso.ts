...
/**
 * Domestic courier reference rows by ISO 3166-1 alpha-2 for EAC members in this module.
 * Reuses BRI layered data where that participant list includes the economy; otherwise informational fallback.
 */
export const EAC_DOMESTIC_COURIERS = Object.fromEntries(
  EAC_MEMBER_ISO_CODES.map((iso2) => [
    iso2,
