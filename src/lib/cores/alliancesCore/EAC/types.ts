/**
 * Reference payloads for EAC members (East African Community — informational; verify for production).
 */
...
/**
 * Reference summary for the EAC itself — informational; verify for production.
 */
export interface EacOrganizationInfo {
  officialName: string
  abbreviation: string
  established: string
