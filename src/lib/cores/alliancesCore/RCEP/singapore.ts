...
export const singapore: RcepCountry = {
  ...
  domesticPostService: RCEP_DOMESTIC_POST_SERVICES['SG'],
  nationalBankingInstitutions: RCEP_NATIONAL_BANKING_INSTITUTIONS['SG'],
  corporationFormationOffice: RCEP_CORPORATION_FORMATION_OFFICES['SG'],
  ...
  mainInternationalSeaport: RCEP_MAIN_INTERNATIONAL_SEAPORTS['SG'],
  intellectualPropertyDepartments: RCEP_INTELLECTUAL_PROPERTY_DEPARTMENTS['SG'],
  securitiesExchangeCommission: RCEP_SECURITIES_EXCHANGE_COMMISSIONS['SG'],
}
