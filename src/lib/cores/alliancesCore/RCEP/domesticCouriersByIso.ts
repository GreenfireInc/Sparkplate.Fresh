...
/**
 * Domestic courier reference rows by ISO 3166-1 alpha-2 for RCEP parties in this module.
 * Reuses BRI layered data where that participant list includes the economy; otherwise informational fallback.
 */
export const RCEP_DOMESTIC_COURIERS = Object.fromEntries(
  RCEP_MEMBER_ISO_CODES.map((iso2) => [
    iso2,
