...
export const philippines: RcepCountry = {
  ...
  domesticPostService: RCEP_DOMESTIC_POST_SERVICES['PH'],
  nationalBankingInstitutions: RCEP_NATIONAL_BANKING_INSTITUTIONS['PH'],
  corporationFormationOffice: RCEP_CORPORATION_FORMATION_OFFICES['PH'],
  ...
  mainInternationalSeaport: RCEP_MAIN_INTERNATIONAL_SEAPORTS['PH'],
