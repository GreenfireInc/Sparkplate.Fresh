/**
 * Reference payloads for MINT members (Mexico, Indonesia, Nigeria, Türkiye — economist / media acronym;
...
/**
 * Reference summary for the MINT grouping — informational; not a chartered intergovernmental body.
 */
export interface MintOrganizationInfo {
  officialName: string
  abbreviation: string
  established: string
