/**
 * Reference payloads for OECD members (Organisation for Economic Co-operation and Development —
...
/**
 * Reference summary for the OECD — informational; verify against oecd.org and Council decisions.
 */
export interface OecdOrganizationInfo {
  officialName: string
  abbreviation: string
  established: string
