...
export const iceland: OecdCountry = {
  ...
  domesticPostService: OECD_DOMESTIC_POST_SERVICES['IS'],
  nationalBankingInstitutions: OECD_NATIONAL_BANKING_INSTITUTIONS['IS'],
  corporationFormationOffice: OECD_CORPORATION_FORMATION_OFFICES['IS'],
  ...
  mainInternationalSeaport: OECD_MAIN_INTERNATIONAL_SEAPORTS['IS'],
