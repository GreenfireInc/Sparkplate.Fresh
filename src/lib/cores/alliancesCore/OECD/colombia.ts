...
export const colombia: OecdCountry = {
  ...
  domesticPostService: OECD_DOMESTIC_POST_SERVICES['CO'],
  nationalBankingInstitutions: OECD_NATIONAL_BANKING_INSTITUTIONS['CO'],
  corporationFormationOffice: OECD_CORPORATION_FORMATION_OFFICES['CO'],
  ...
  mainInternationalSeaport: OECD_MAIN_INTERNATIONAL_SEAPORTS['CO'],
  intellectualPropertyDepartments: OECD_INTELLECTUAL_PROPERTY_DEPARTMENTS['CO'],
  securitiesExchangeCommission: OECD_SECURITIES_EXCHANGE_COMMISSIONS['CO'],
}
