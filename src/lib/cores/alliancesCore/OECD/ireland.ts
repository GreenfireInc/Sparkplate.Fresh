...
export const ireland: OecdCountry = {
  ...
  domesticPostService: OECD_DOMESTIC_POST_SERVICES['IE'],
  nationalBankingInstitutions: OECD_NATIONAL_BANKING_INSTITUTIONS['IE'],
  corporationFormationOffice: OECD_CORPORATION_FORMATION_OFFICES['IE'],
  ...
  mainInternationalAirport: OECD_MAIN_INTERNATIONAL_AIRPORTS['IE'],
  mainInternationalSeaport: OECD_MAIN_INTERNATIONAL_SEAPORTS['IE'],
  intellectualPropertyDepartments: OECD_INTELLECTUAL_PROPERTY_DEPARTMENTS['IE'],
  securitiesExchangeCommission: OECD_SECURITIES_EXCHANGE_COMMISSIONS['IE'],
}
