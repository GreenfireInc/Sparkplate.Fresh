...
export const dominica: CaricomCountry = {
  ...
  domesticPostService: CARICOM_DOMESTIC_POST_SERVICES['DM'],
  nationalBankingInstitutions: CARICOM_NATIONAL_BANKING_INSTITUTIONS['DM'],
  corporationFormationOffice: CARICOM_CORPORATION_FORMATION_OFFICES['DM'],
  ...
  mainInternationalSeaport: CARICOM_MAIN_INTERNATIONAL_SEAPORTS['DM'],
}
