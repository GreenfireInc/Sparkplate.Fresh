...
export const belize: CaricomCountry = {
  ...
  domesticPostService: CARICOM_DOMESTIC_POST_SERVICES['BZ'],
  nationalBankingInstitutions: CARICOM_NATIONAL_BANKING_INSTITUTIONS['BZ'],
  corporationFormationOffice: CARICOM_CORPORATION_FORMATION_OFFICES['BZ'],
  ...
  mainInternationalSeaport: CARICOM_MAIN_INTERNATIONAL_SEAPORTS['BZ'],
}
