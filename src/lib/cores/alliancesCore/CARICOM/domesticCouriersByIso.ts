...
/**
 * Domestic courier reference rows by ISO 3166-1 alpha-2 for CARICOM entries in this module.
 * Reuses BRI layered data where that participant list includes the economy; otherwise informational fallback.
 */
export const CARICOM_DOMESTIC_COURIERS = Object.fromEntries(
  CARICOM_MEMBER_ISO_CODES.map((iso2) => [
    iso2,
