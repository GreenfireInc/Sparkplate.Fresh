...
export const southAfrica: AfricanUnionCountry = {
  ...
  domesticPostService: AU_DOMESTIC_POST_SERVICES['ZA'],
  nationalBankingInstitutions: AU_NATIONAL_BANKING_INSTITUTIONS['ZA'],
  corporationFormationOffice: AU_CORPORATION_FORMATION_OFFICES['ZA'],
  ...
  mainInternationalSeaport: AU_MAIN_INTERNATIONAL_SEAPORTS['ZA'],
}
