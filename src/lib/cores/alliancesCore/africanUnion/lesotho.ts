...
export const lesotho: AfricanUnionCountry = {
  ...
  domesticPostService: AU_DOMESTIC_POST_SERVICES['LS'],
  nationalBankingInstitutions: AU_NATIONAL_BANKING_INSTITUTIONS['LS'],
  corporationFormationOffice: AU_CORPORATION_FORMATION_OFFICES['LS'],
  ...
  mainInternationalSeaport: AU_MAIN_INTERNATIONAL_SEAPORTS['LS'],
}
