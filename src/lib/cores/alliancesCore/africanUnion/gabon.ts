...
export const gabon: AfricanUnionCountry = {
  ...
  domesticPostService: AU_DOMESTIC_POST_SERVICES['GA'],
  nationalBankingInstitutions: AU_NATIONAL_BANKING_INSTITUTIONS['GA'],
  corporationFormationOffice: AU_CORPORATION_FORMATION_OFFICES['GA'],
  ...
  mainInternationalSeaport: AU_MAIN_INTERNATIONAL_SEAPORTS['GA'],
}
