...
export const netherlands: EuCountry = {
  ...
  domesticPostService: EU_DOMESTIC_POST_SERVICES['NL'],
  nationalBankingInstitutions: EU_NATIONAL_BANKING_INSTITUTIONS['NL'],
  corporationFormationOffice: EU_CORPORATION_FORMATION_OFFICES['NL'],
  ...
  mainInternationalSeaport: EU_MAIN_INTERNATIONAL_SEAPORTS['NL'],
}
