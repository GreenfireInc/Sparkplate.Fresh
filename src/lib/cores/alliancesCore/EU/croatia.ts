...
export const croatia: EuCountry = {
  ...
  domesticPostService: EU_DOMESTIC_POST_SERVICES['HR'],
  nationalBankingInstitutions: EU_NATIONAL_BANKING_INSTITUTIONS['HR'],
  corporationFormationOffice: EU_CORPORATION_FORMATION_OFFICES['HR'],
  ...
  intellectualPropertyDepartments: EU_INTELLECTUAL_PROPERTY_DEPARTMENTS['HR'],

  securitiesExchangeCommission: EU_SECURITIES_EXCHANGE_COMMISSIONS['HR'],
  mainInternationalAirport: EU_MAIN_INTERNATIONAL_AIRPORTS['HR'],
  mainInternationalSeaport: EU_MAIN_INTERNATIONAL_SEAPORTS['HR'],
}
