...
export const denmark: EuCountry = {
  ...
  domesticPostService: EU_DOMESTIC_POST_SERVICES['DK'],
  nationalBankingInstitutions: EU_NATIONAL_BANKING_INSTITUTIONS['DK'],
  corporationFormationOffice: EU_CORPORATION_FORMATION_OFFICES['DK'],
  ...
  intellectualPropertyDepartments: EU_INTELLECTUAL_PROPERTY_DEPARTMENTS['DK'],

  securitiesExchangeCommission: EU_SECURITIES_EXCHANGE_COMMISSIONS['DK'],
  mainInternationalAirport: EU_MAIN_INTERNATIONAL_AIRPORTS['DK'],
  mainInternationalSeaport: EU_MAIN_INTERNATIONAL_SEAPORTS['DK'],
}
