/**
 * Reference payloads for SADC members (Southern African Development Community — informational; verify for production).
 */
...
/**
 * Reference summary for SADC itself — informational; verify for production.
 */
export interface SadcOrganizationInfo {
  officialName: string
  abbreviation: string
  established: string
