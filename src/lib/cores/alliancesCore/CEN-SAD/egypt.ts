...
export const egypt: CensadCountry = {
  ...
  domesticPostService: CENSAD_DOMESTIC_POST_SERVICES['EG'],
  nationalBankingInstitutions: CENSAD_NATIONAL_BANKING_INSTITUTIONS['EG'],
  corporationFormationOffice: CENSAD_CORPORATION_FORMATION_OFFICES['EG'],
  ...
  mainInternationalSeaport: CENSAD_MAIN_INTERNATIONAL_SEAPORTS['EG'],
}
