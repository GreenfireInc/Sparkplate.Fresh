...
export const guinea: CensadCountry = {
  ...
  domesticPostService: CENSAD_DOMESTIC_POST_SERVICES['GN'],
  nationalBankingInstitutions: CENSAD_NATIONAL_BANKING_INSTITUTIONS['GN'],
  corporationFormationOffice: CENSAD_CORPORATION_FORMATION_OFFICES['GN'],
  ...
  mainInternationalSeaport: CENSAD_MAIN_INTERNATIONAL_SEAPORTS['GN'],
}
