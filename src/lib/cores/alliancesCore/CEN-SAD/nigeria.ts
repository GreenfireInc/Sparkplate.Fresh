...
export const nigeria: CensadCountry = {
  ...
  domesticPostService: CENSAD_DOMESTIC_POST_SERVICES['NG'],
  nationalBankingInstitutions: CENSAD_NATIONAL_BANKING_INSTITUTIONS['NG'],
  corporationFormationOffice: CENSAD_CORPORATION_FORMATION_OFFICES['NG'],
  ...
  mainInternationalSeaport: CENSAD_MAIN_INTERNATIONAL_SEAPORTS['NG'],
}
