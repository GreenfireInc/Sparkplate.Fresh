...
export const mauritania: CensadCountry = {
  ...
  domesticPostService: CENSAD_DOMESTIC_POST_SERVICES['MR'],
  nationalBankingInstitutions: CENSAD_NATIONAL_BANKING_INSTITUTIONS['MR'],
  corporationFormationOffice: CENSAD_CORPORATION_FORMATION_OFFICES['MR'],
  ...
  mainInternationalSeaport: CENSAD_MAIN_INTERNATIONAL_SEAPORTS['MR'],
}
