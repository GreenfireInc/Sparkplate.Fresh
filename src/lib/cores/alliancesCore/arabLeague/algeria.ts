...
export const algeria: ArabLeagueCountry = {
  ...
  domesticPostService: ARAB_LEAGUE_DOMESTIC_POST_SERVICES['DZ'],
  nationalBankingInstitutions: ARAB_LEAGUE_NATIONAL_BANKING_INSTITUTIONS['DZ'],
  corporationFormationOffice: ARAB_LEAGUE_CORPORATION_FORMATION_OFFICES['DZ'],
  ...
  mainInternationalSeaport: ARAB_LEAGUE_MAIN_INTERNATIONAL_SEAPORTS['DZ'],
}
