 ...
 * and API bases before production). `apiEndpoint` almost always empty.
 */
...
export interface ArabLeagueCountry {
  ...
  /**
   * Documented bond market venues — listed-bond exchanges, sovereign primary-market desks,
   * and central-bank auction platforms. Empty array when no bond venue is documented.
   */
