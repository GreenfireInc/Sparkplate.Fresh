...
export const spain: NatoCountry = {
  ...
  domesticPostService: NATO_DOMESTIC_POST_SERVICES['ES'],
  nationalBankingInstitutions: NATO_NATIONAL_BANKING_INSTITUTIONS['ES'],
  corporationFormationOffice: NATO_CORPORATION_FORMATION_OFFICES['ES'],
  ...
  mainInternationalSeaport: NATO_MAIN_INTERNATIONAL_SEAPORTS['ES'],
