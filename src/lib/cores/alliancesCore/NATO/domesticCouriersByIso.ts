...
/**
 * Domestic courier reference rows by ISO 3166-1 alpha-2 for NATO Allies in this module.
 * Reuses BRI layered data where that participant list includes the economy; otherwise informational fallback.
 */
export const NATO_DOMESTIC_COURIERS = Object.fromEntries(
  NATO_MEMBER_ISO_CODES.map((iso2) => [
    iso2,
