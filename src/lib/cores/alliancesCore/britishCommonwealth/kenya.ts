...
export const kenya: CommonwealthCountry = {
  ...
  domesticPostService: COMMONWEALTH_DOMESTIC_POST_SERVICES['KE'],
  nationalBankingInstitutions: COMMONWEALTH_NATIONAL_BANKING_INSTITUTIONS['KE'],
  corporationFormationOffice: COMMONWEALTH_CORPORATION_FORMATION_OFFICES['KE'],
  ...
  intellectualPropertyDepartments: COMMONWEALTH_INTELLECTUAL_PROPERTY_DEPARTMENTS['KE'],
  securitiesExchangeCommission: COMMONWEALTH_SECURITIES_EXCHANGE_COMMISSIONS['KE'],
  mainInternationalAirport: COMMONWEALTH_MAIN_INTERNATIONAL_AIRPORTS['KE'],
  mainInternationalSeaport: COMMONWEALTH_MAIN_INTERNATIONAL_SEAPORTS['KE'],
}
