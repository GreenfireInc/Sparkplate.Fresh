...
export const saintKittsAndNevis: CommonwealthCountry = {
  ...
  domesticPostService: COMMONWEALTH_DOMESTIC_POST_SERVICES['KN'],
  nationalBankingInstitutions: COMMONWEALTH_NATIONAL_BANKING_INSTITUTIONS['KN'],
  corporationFormationOffice: COMMONWEALTH_CORPORATION_FORMATION_OFFICES['KN'],
  ...
  mainInternationalSeaport: COMMONWEALTH_MAIN_INTERNATIONAL_SEAPORTS['KN'],
}
