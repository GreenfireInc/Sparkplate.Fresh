...
export const jamaica: CommonwealthCountry = {
  ...
  domesticPostService: COMMONWEALTH_DOMESTIC_POST_SERVICES['JM'],
  nationalBankingInstitutions: COMMONWEALTH_NATIONAL_BANKING_INSTITUTIONS['JM'],
  corporationFormationOffice: COMMONWEALTH_CORPORATION_FORMATION_OFFICES['JM'],
  ...
  mainInternationalSeaport: COMMONWEALTH_MAIN_INTERNATIONAL_SEAPORTS['JM'],
}
