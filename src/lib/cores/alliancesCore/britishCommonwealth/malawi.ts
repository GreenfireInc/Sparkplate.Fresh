...
export const malawi: CommonwealthCountry = {
  ...
  domesticPostService: COMMONWEALTH_DOMESTIC_POST_SERVICES['MW'],
  nationalBankingInstitutions: COMMONWEALTH_NATIONAL_BANKING_INSTITUTIONS['MW'],
  corporationFormationOffice: COMMONWEALTH_CORPORATION_FORMATION_OFFICES['MW'],
  ...
  mainInternationalSeaport: COMMONWEALTH_MAIN_INTERNATIONAL_SEAPORTS['MW'],
}
