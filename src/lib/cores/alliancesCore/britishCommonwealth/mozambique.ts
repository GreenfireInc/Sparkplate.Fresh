...
export const mozambique: CommonwealthCountry = {
  ...
  domesticPostService: COMMONWEALTH_DOMESTIC_POST_SERVICES['MZ'],
  nationalBankingInstitutions: COMMONWEALTH_NATIONAL_BANKING_INSTITUTIONS['MZ'],
  corporationFormationOffice: COMMONWEALTH_CORPORATION_FORMATION_OFFICES['MZ'],
  ...
  mainInternationalSeaport: COMMONWEALTH_MAIN_INTERNATIONAL_SEAPORTS['MZ'],
}
