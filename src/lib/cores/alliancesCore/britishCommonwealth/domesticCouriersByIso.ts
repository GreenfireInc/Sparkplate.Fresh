...
/** Template rows when no curated BRI participant row exists yet for this ISO (informational). */
...
/**
 * Domestic courier reference rows by ISO 3166-1 alpha-2 for Commonwealth members in this module.
 * Reuses BRI layered data where that participant list includes the economy; otherwise informational fallback.
 */
export const COMMONWEALTH_DOMESTIC_COURIERS = Object.fromEntries(
  COMMONWEALTH_MEMBER_ISO_CODES.map((iso2) => [
    iso2,
