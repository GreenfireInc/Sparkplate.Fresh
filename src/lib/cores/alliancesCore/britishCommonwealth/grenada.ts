...
export const grenada: CommonwealthCountry = {
  ...
  domesticPostService: COMMONWEALTH_DOMESTIC_POST_SERVICES['GD'],
  nationalBankingInstitutions: COMMONWEALTH_NATIONAL_BANKING_INSTITUTIONS['GD'],
  corporationFormationOffice: COMMONWEALTH_CORPORATION_FORMATION_OFFICES['GD'],
  ...
  mainInternationalSeaport: COMMONWEALTH_MAIN_INTERNATIONAL_SEAPORTS['GD'],
}
