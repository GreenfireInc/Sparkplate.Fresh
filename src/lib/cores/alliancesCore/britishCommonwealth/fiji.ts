...
export const fiji: CommonwealthCountry = {
  ...
  domesticPostService: COMMONWEALTH_DOMESTIC_POST_SERVICES['FJ'],
  nationalBankingInstitutions: COMMONWEALTH_NATIONAL_BANKING_INSTITUTIONS['FJ'],
  corporationFormationOffice: COMMONWEALTH_CORPORATION_FORMATION_OFFICES['FJ'],
  ...
  mainInternationalSeaport: COMMONWEALTH_MAIN_INTERNATIONAL_SEAPORTS['FJ'],
}
