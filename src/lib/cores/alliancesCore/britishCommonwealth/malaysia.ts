...
export const malaysia: CommonwealthCountry = {
  ...
  domesticPostService: COMMONWEALTH_DOMESTIC_POST_SERVICES['MY'],
  nationalBankingInstitutions: COMMONWEALTH_NATIONAL_BANKING_INSTITUTIONS['MY'],
  corporationFormationOffice: COMMONWEALTH_CORPORATION_FORMATION_OFFICES['MY'],
  ...
  intellectualPropertyDepartments: COMMONWEALTH_INTELLECTUAL_PROPERTY_DEPARTMENTS['MY'],
  securitiesExchangeCommission: COMMONWEALTH_SECURITIES_EXCHANGE_COMMISSIONS['MY'],
  mainInternationalAirport: COMMONWEALTH_MAIN_INTERNATIONAL_AIRPORTS['MY'],
  mainInternationalSeaport: COMMONWEALTH_MAIN_INTERNATIONAL_SEAPORTS['MY'],
}
