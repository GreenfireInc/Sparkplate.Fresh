...
export const southSudan: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['SS'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['SS'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['SS'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['SS'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['SS'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['SS'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['SS'],
}
