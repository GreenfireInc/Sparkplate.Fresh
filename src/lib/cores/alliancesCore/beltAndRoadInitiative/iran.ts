...
export const iran: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['IR'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['IR'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['IR'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['IR'],
}
