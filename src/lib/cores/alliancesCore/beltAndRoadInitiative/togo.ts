...
export const togo: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['TG'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['TG'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['TG'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['TG'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['TG'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['TG'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['TG'],
}
