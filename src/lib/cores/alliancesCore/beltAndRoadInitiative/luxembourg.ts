...
export const luxembourg: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['LU'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['LU'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['LU'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['LU'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['LU'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['LU'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['LU'],
}
