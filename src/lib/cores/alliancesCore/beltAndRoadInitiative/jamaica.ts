...
export const jamaica: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['JM'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['JM'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['JM'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['JM'],
}
