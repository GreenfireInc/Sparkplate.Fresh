...
export const niger: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['NE'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['NE'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['NE'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['NE'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['NE'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['NE'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['NE'],
}
