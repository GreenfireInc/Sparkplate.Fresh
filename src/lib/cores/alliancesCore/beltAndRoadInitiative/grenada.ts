...
export const grenada: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['GD'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['GD'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['GD'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['GD'],
}
