...
export const papuaNewGuinea: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['PG'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['PG'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['PG'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['PG'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['PG'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['PG'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['PG'],
}
