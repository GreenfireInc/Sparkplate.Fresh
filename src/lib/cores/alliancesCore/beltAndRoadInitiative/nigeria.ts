...
export const nigeria: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['NG'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['NG'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['NG'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['NG'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['NG'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['NG'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['NG'],
}
