...
import { cookIslands } from './cookIslands'
...
/** BRI partner-country records in this module (151). Order matches the source country list. */
...
export const beltAndRoadInitiative: BeltAndRoadInitiativeOrganizationInfo = {
  ...
  participantStatesIso2: BELT_AND_ROAD_PARTICIPANT_ISO_CODES,
  memberRecordsInModule: 151,
}
