...
export const romania: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['RO'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['RO'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['RO'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['RO'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['RO'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['RO'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['RO'],
}
