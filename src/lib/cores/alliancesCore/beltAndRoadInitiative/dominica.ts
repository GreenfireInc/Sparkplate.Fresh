...
export const dominica: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['DM'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['DM'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['DM'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['DM'],
}
