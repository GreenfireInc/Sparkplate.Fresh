...
export const morocco: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['MA'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['MA'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['MA'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['MA'],
}
