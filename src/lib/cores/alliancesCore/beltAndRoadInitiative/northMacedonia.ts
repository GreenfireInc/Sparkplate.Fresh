...
export const northMacedonia: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['MK'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['MK'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['MK'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['MK'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['MK'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['MK'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['MK'],
}
