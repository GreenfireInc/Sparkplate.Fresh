...
export const iraq: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['IQ'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['IQ'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['IQ'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['IQ'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['IQ'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['IQ'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['IQ'],
}
