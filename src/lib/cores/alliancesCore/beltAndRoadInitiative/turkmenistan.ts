...
export const turkmenistan: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['TM'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['TM'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['TM'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['TM'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['TM'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['TM'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['TM'],
}
