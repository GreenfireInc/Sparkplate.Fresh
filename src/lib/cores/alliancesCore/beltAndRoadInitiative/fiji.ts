...
export const fiji: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['FJ'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['FJ'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['FJ'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['FJ'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['FJ'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['FJ'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['FJ'],
}
