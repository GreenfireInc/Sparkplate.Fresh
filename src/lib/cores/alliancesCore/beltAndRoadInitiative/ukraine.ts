...
export const ukraine: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['UA'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['UA'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['UA'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['UA'],
}
