...
export const cuba: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['CU'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['CU'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['CU'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['CU'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['CU'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['CU'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['CU'],
}
