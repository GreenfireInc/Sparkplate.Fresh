...
export const egypt: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['EG'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['EG'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['EG'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['EG'],
}
