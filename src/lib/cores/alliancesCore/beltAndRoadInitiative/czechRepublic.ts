...
export const czechRepublic: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['CZ'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['CZ'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['CZ'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['CZ'],
}
