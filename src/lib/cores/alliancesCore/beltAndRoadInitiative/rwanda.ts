...
export const rwanda: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['RW'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['RW'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['RW'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['RW'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['RW'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['RW'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['RW'],
}
