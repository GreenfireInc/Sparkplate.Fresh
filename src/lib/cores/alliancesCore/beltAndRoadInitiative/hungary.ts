...
export const hungary: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['HU'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['HU'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['HU'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['HU'],
}
