...
export const ecuador: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['EC'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['EC'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['EC'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['EC'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['EC'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['EC'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['EC'],
}
