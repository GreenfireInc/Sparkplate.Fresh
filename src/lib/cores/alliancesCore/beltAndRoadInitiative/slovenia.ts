...
export const slovenia: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['SI'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['SI'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['SI'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['SI'],
}
