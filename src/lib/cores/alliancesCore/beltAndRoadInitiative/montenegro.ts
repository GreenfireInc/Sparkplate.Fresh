...
export const montenegro: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['ME'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['ME'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['ME'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['ME'],
}
