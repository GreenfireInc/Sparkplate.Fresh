...
export const chile: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['CL'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['CL'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['CL'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['CL'],
}
