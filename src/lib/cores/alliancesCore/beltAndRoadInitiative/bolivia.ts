...
export const bolivia: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['BO'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['BO'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['BO'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['BO'],
}
