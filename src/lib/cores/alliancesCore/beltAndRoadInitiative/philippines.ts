...
export const philippines: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['PH'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['PH'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['PH'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['PH'],
}
