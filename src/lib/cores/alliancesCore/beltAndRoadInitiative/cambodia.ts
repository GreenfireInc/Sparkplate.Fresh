...
export const cambodia: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['KH'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['KH'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['KH'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['KH'],
}
