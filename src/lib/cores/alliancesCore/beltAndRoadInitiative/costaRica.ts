...
export const costaRica: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['CR'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['CR'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['CR'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['CR'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['CR'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['CR'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['CR'],
}
