...
export const cookIslands: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['CK'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['CK'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['CK'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['CK'],
}
