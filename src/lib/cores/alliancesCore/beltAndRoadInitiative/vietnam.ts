...
export const vietnam: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['VN'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['VN'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['VN'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['VN'],
}
