...
export const barbados: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['BB'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['BB'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['BB'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['BB'],
}
