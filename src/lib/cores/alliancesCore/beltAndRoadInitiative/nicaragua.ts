...
export const nicaragua: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['NI'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['NI'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['NI'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['NI'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['NI'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['NI'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['NI'],
}
