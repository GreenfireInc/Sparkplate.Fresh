...
export const cameroon: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['CM'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['CM'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['CM'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['CM'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['CM'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['CM'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['CM'],
}
