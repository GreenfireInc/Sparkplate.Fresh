...
export const myanmar: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['MM'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['MM'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['MM'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['MM'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['MM'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['MM'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['MM'],
}
