...
export const zambia: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['ZM'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['ZM'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['ZM'],
  ...
  intellectualPropertyDepartments: BRI_INTELLECTUAL_PROPERTY_DEPARTMENTS['ZM'],
  securitiesExchangeCommission: BRI_SECURITIES_EXCHANGE_COMMISSIONS['ZM'],
  mainInternationalAirport: BRI_MAIN_INTERNATIONAL_AIRPORTS['ZM'],
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['ZM'],
}
