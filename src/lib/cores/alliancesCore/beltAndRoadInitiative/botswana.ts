...
export const botswana: BeltAndRoadInitiativeCountry = {
  ...
  domesticPostService: BRI_DOMESTIC_POST_SERVICES['BW'],
  nationalBankingInstitutions: BRI_NATIONAL_BANKING_INSTITUTIONS['BW'],
  corporationFormationOffice: BRI_CORPORATION_FORMATION_OFFICES['BW'],
  ...
  mainInternationalSeaport: BRI_MAIN_INTERNATIONAL_SEAPORTS['BW'],
}
