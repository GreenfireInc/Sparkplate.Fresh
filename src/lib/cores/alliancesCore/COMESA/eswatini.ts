...
export const eswatini: ComesaCountry = {
  ...
  domesticPostService: COMESA_DOMESTIC_POST_SERVICES['SZ'],
  nationalBankingInstitutions: COMESA_NATIONAL_BANKING_INSTITUTIONS['SZ'],
  corporationFormationOffice: COMESA_CORPORATION_FORMATION_OFFICES['SZ'],
  ...
  mainInternationalSeaport: COMESA_MAIN_INTERNATIONAL_SEAPORTS['SZ'],
}
