...
export const malawi: ComesaCountry = {
  ...
  domesticPostService: COMESA_DOMESTIC_POST_SERVICES['MW'],
  nationalBankingInstitutions: COMESA_NATIONAL_BANKING_INSTITUTIONS['MW'],
  corporationFormationOffice: COMESA_CORPORATION_FORMATION_OFFICES['MW'],
  ...
  mainInternationalSeaport: COMESA_MAIN_INTERNATIONAL_SEAPORTS['MW'],
}
