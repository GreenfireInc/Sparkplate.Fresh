...
export const saudiArabia: OpecCountry = {
  ...
  domesticPostService: OPEC_DOMESTIC_POST_SERVICES['SA'],
  nationalBankingInstitutions: OPEC_NATIONAL_BANKING_INSTITUTIONS['SA'],
  corporationFormationOffice: OPEC_CORPORATION_FORMATION_OFFICES['SA'],
  ...
  mainInternationalAirport: OPEC_MAIN_INTERNATIONAL_AIRPORTS['SA'],
  mainInternationalSeaport: OPEC_MAIN_INTERNATIONAL_SEAPORTS['SA'],
  intellectualPropertyDepartments: OPEC_INTELLECTUAL_PROPERTY_DEPARTMENTS['SA'],
  securitiesExchangeCommission: OPEC_SECURITIES_EXCHANGE_COMMISSIONS['SA'],
}
