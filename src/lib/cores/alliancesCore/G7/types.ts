/**
 * Reference payloads for G7 members (Group of Seven — informational; verify for production).
 */
...
/**
 * Reference summary for the Group of Seven — informational; verify for production.
 */
export interface G7OrganizationInfo {
  officialName: string
  abbreviation: string
  established: string
