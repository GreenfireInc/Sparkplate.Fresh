...
/**
 * Domestic courier reference rows by ISO 3166-1 alpha-2 for Five Eyes members in this module.
 * Reuses BRI layered data where that participant list includes the economy; otherwise informational fallback.
 */
export const FIVE_EYES_DOMESTIC_COURIERS = Object.fromEntries(
  FIVE_EYES_MEMBER_ISO_CODES.map((iso2) => [
    iso2,
