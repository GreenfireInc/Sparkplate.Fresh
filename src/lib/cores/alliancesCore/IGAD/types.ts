/**
 * Reference payloads for IGAD members (Intergovernmental Authority on Development — informational;
...
/**
 * Reference summary for IGAD — informational; verify against Secretariat communiqués and summit decisions.
 */
export interface IgadOrganizationInfo {
  officialName: string
  abbreviation: string
  established: string
