/**
 * Reference payloads for CPTPP members / parties (Comprehensive and Progressive Agreement for Trans-Pacific Partnership — informational; verify for production).
 */
...
/** Copyright, trademarks, and patents competent offices per party (informational; verify). */
...
/**
 * Reference summary for CPTPP itself — informational; verify for production.
 */
export interface CptppOrganizationInfo {
  officialName: string
  abbreviation: string
  established: string
