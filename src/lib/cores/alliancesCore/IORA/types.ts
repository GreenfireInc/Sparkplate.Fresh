/**
 * Reference payloads for IORA members (Indian Ocean Rim Association — informational; verify for production).
 */
...
/**
 * Reference summary for IORA — informational; verify against iora.int instruments.
 */
export interface IoraOrganizationInfo {
  officialName: string
  abbreviation: string
  established: string
