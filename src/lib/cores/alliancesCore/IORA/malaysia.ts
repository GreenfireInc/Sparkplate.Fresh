...
export const malaysia: IoraCountry = {
  ...
  domesticPostService: IORA_DOMESTIC_POST_SERVICES['MY'],
  nationalBankingInstitutions: IORA_NATIONAL_BANKING_INSTITUTIONS['MY'],
  corporationFormationOffice: IORA_CORPORATION_FORMATION_OFFICES['MY'],
  ...
  mainInternationalSeaport: IORA_MAIN_INTERNATIONAL_SEAPORTS['MY'],
  intellectualPropertyDepartments: IORA_INTELLECTUAL_PROPERTY_DEPARTMENTS['MY'],
  securitiesExchangeCommission: IORA_SECURITIES_EXCHANGE_COMMISSIONS['MY'],
}
