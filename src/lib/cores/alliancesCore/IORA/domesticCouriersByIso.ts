...
/**
 * Domestic courier reference rows by ISO 3166-1 alpha-2 for IORA members in this module.
 * Reuses BRI layered data where that participant list includes the economy; otherwise informational fallback.
 */
export const IORA_DOMESTIC_COURIERS = Object.fromEntries(
  IORA_MEMBER_ISO_CODES.map((iso2) => [
    iso2,
