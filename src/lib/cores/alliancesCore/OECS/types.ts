/**
 * Reference payloads for OECS members (Organisation of Eastern Caribbean States — informational;
...
/**
 * Reference summary for the OECS — informational; verify against Revised Treaty of Basseterre instruments.
 */
export interface OecsOrganizationInfo {
  officialName: string
  abbreviation: string
  established: string
