...
export const montserrat: OecsCountry = {
  ...
  domesticPostService: OECS_DOMESTIC_POST_SERVICES['MS'],
  nationalBankingInstitutions: OECS_NATIONAL_BANKING_INSTITUTIONS['MS'],
  corporationFormationOffice: OECS_CORPORATION_FORMATION_OFFICES['MS'],
  ...
  mainInternationalSeaport: OECS_MAIN_INTERNATIONAL_SEAPORTS['MS'],
