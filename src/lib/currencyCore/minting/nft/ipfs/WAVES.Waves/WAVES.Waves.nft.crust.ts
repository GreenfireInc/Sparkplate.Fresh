// Waves NFT Minting via Crust Network
...
export class WavesCrustNFTMinter {
  ...
  constructor(crustConfig: CrustConfig, nodeUrl: string = 'https://nodes.wavesnodes.com', chainId: 'W' | 'T' = 'W') {
...
export default WavesCrustNFTMinter;
