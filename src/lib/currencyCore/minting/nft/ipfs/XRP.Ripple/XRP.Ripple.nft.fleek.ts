// XRP NFT Minting via Fleek IPFS
...
export class XRPFleekNFTMinter {
  ...
  constructor(fleekConfig: FleekConfig, xrplServer: string = 'wss://xrplcluster.com', network: 'mainnet' | 'testnet' | 'devnet' = 'mainnet') {
...
export default XRPFleekNFTMinter;
