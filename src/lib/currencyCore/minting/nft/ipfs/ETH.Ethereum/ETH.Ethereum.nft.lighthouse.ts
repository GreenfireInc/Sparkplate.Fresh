// Ethereum NFT Minting via Lighthouse IPFS
...
export class ETHLighthouseNFTMinter {
  ...
  constructor(lighthouseConfig: LighthouseConfig, rpcEndpoint: string = 'https://eth.llamarpc.com', network: 'mainnet' | 'sepolia' | 'goerli' = 'mainnet') { this.lighthouseConfig = lighthouseConfig; this.rpcEndpoint = rpcEndpoint; this.network = network; }
...
export default ETHLighthouseNFTMinter;
