// Terra Classic NFT Minting via Filebase IPFS
...
export class TerraClassicFilebaseNFTMinter {
  private s3: AWS.S3;
  ...
  constructor(filebaseConfig: FilebaseConfig, rpcEndpoint: string = 'https://terra-classic-lcd.publicnode.com', network: 'mainnet' | 'testnet' = 'mainnet') {
...
export default TerraClassicFilebaseNFTMinter;
