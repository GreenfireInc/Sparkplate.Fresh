// Stellar NFT Minting via Fleek IPFS
...
export class StellarFleekNFTMinter {
  ...
  constructor(fleekConfig: FleekConfig, horizonUrl: string = 'https://horizon.stellar.org', network: 'mainnet' | 'testnet' = 'mainnet') {
...
export default StellarFleekNFTMinter;
