...
import { sideShiftDEX } from './sideShift.LTC';
import { changeNOWDEX } from './changeNOW.LTC';
import { simpleSwapDEX } from './simpleSwap.LTC';
import { stealthEXDEX } from './stealthEX.LTC';
import { fixedFloatDEX } from './fixedFloat.LTC';
import { exolixDEX } from './exolix.LTC';
import { letsExchangeDEX } from './letsExchange.LTC';
...
export const litecoinExchanges = {
  sideShift: () => import('./sideShift.LTC').then(m => m.sideShiftDEX),
  changeNOW: () => import('./changeNOW.LTC').then(m => m.changeNOWDEX),
  simpleSwap: () => import('./simpleSwap.LTC').then(m => m.simpleSwapDEX),
  stealthEX: () => import('./stealthEX.LTC').then(m => m.stealthEXDEX),
  fixedFloat: () => import('./fixedFloat.LTC').then(m => m.fixedFloatDEX),
  exolix: () => import('./exolix.LTC').then(m => m.exolixDEX),
  letsExchange: () => import('./letsExchange.LTC').then(m => m.letsExchangeDEX),
};
