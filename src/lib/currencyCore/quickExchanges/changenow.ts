// ChangeNOW Quick Exchange API Integration
...
export class ChangeNOWExchangeClass {
  private config: ChangeNOWConfig;
  private baseUrl: string;

  constructor(config: ChangeNOWConfig = {}) {
    this.config = config;
    this.baseUrl = config.baseUrl || (config.sandbox ? 'https://api-sandbox.changenow.io' : 'https://api.changenow.io');
  }
  ...
  static readonly info = {
    ...
    features: ['No KYC', 'Fast Exchange', 'Low Fees', 'Fixed Rate'],
  };

  // Social Media Links
  static readonly socialMedia = {
    twitter: 'https://twitter.com/ChangeNOW_io',
    telegram: 'https://t.me/ChangeNOW_io',
    reddit: 'https://www.reddit.com/r/ChangeNOW_io/',
    youtube: 'https://www.youtube.com/ChangeNOW_io',
    facebook: 'https://www.facebook.com/ChangeNOW_io',
    linkedin: 'https://www.linkedin.com/company/changenow',
  };

  /**
   * Make request to ChangeNOW API
   */
  private async makeRequest(endpoint: string, params: Record<string, any> = {}): Promise<any> {
    ...
    if (result.error) {
      throw new Error(`ChangeNOW API error: ${result.error}`);
    }
...
export const ChangeNOWExchange = {
  // Quick access methods
  async getCurrencies(): Promise<string[]> {
    const instance = new ChangeNOWExchangeClass();
  ...
  // Static properties
  info: ChangeNOWExchangeClass.info,
  socialMedia: ChangeNOWExchangeClass.socialMedia,
};

// Export the class as default
export default ChangeNOWExchange;
