// Binance Exchange Staking for TRX
...
const response = await fetch('https://api.binance.com/sapi/v1/staking/stakingProductList?product=STAKING&asset=TRX', {
  headers: {
...
console.log('Staking products:', products);
    ...
    getStakingRecord: `
// Get staking record
const response = await fetch('https://api.binance.com/sapi/v1/staking/stakingRecord?product=STAKING&asset=TRX', {
  headers: {
    'X-MBX-APIKEY': 'YOUR_API_KEY',
  },
});
...
console.log('Staking record:', record);
    ...
    getRewardsHistory: `
// Get rewards history
const response = await fetch('https://api.binance.com/sapi/v1/staking/stakingRewardsHistory?product=STAKING&asset=TRX', {
  headers: {
    'X-MBX-APIKEY': 'YOUR_API_KEY',
  },
});
