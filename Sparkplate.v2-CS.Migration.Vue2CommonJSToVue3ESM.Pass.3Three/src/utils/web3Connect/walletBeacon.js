...
export function handlePermissionRequest(request, params) {
  return {
...
export async function handleSignPayloadRequest(request, params) {
...
export async function handleOperationRequest(request, params) {
...
export async function handleBroadcastRequest(request, params) {
...
export function fillOperationDetails(request) {
