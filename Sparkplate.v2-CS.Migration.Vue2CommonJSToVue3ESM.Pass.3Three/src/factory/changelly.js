...
export const changellyApiKey = import.meta.env.VITE_CHANGELLY_API_KEY
export const changellyApiSecret = import.meta.env.VITE_CHANGELLY_API_SECRET
export const changelly = new Changelly(changellyApiKey, changellyApiSecret)
